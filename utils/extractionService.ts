...
export class UnifiedFinancialExtractor {
  ...
  async extractSegmentProfitLoss(base64Content: string): Promise<ExtractionResult> {
...
回答は抽出した値のみを返してください。説明は不要です。`;
  ...
  async extractTotalLiabilities(base64Content: string): Promise<ExtractionResult> {
...
回答は抽出した値のみを返してください。説明は不要です。`;
  ...
  async extractCurrentLiabilities(base64Content: string): Promise<ExtractionResult> {
...
回答は抽出した値のみを返してください。説明は不要です。`;
  ...
  async extractOrdinaryExpenses(base64Content: string): Promise<ExtractionResult> {
...
回答は抽出した値のみを返してください。説明は不要です。`;
  ...
  private async extractValue(base64Content: string, prompt: string): Promise<ExtractionResult> {
    try {
  ...
  private parseJapaneseNumber(value: string): number | null {
